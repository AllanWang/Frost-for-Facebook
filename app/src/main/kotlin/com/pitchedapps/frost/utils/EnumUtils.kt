 ...
 *
 * Helper to set enum using its name rather than the serialized version Name is used in case the
 * enum is involved in persistent data, where updates may shift indices
 */
