...
fun SettingsActivity.getFeedPrefs(): KPrefAdapterBuilder.() -> Unit = {
  ...
  checkbox(
    R.string.suggested_friends,
    prefs::showSuggestedFriends,
    {
  ...
  checkbox(
    R.string.suggested_groups,
    prefs::showSuggestedGroups,
    {
  ...
  checkbox(
    R.string.show_post_actions,
    prefs::showPostActions,
    {
  ...
  checkbox(
    R.string.show_post_reactions,
    prefs::showPostReactions,
    {
